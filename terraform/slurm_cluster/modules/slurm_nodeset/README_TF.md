...
| <a name="input_experimental_features"></a> [experimental\_features](#input\_experimental\_features) | Experimental features to enable on the nodes | `any` | `null` | no |
...
| <a name="input_maintenance_interval"></a> [maintenance\_interval](#input\_maintenance\_interval) | Sets the maintenance interval for instances in this nodeset.<br>See https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_instance#maintenance_interval. | `string` | `""` | no |
